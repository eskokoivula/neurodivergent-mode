...
A right reframe and a confident wrong one look the same on the page. So the skill doesn't just generate — it runs every reframe through an adversarial **selection layer** before shipping it.
